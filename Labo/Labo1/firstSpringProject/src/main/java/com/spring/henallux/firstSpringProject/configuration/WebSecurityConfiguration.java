...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    private static final String[] AUTHORIZED_REQUESTS_ANYBODY = new String[]{"/page","/WEB_INF/jsp/include/**","/WEB-INF/jsp/template/**","/js/**","/css/**","/images/**","/fonts/**","/WEB-INF/**"};
    private static final String[] AUTHORIZED_REQUESTS_ADMIN = new String[]{"/admin"};
    //private static final String[] PAGE_REQUEST = new String[]{"/hello3"};
